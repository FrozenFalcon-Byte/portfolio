    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'center', width: '100%', overflow: 'hidden' }}>
        <motion.h1 
          ...
          style={{ fontFamily: 'var(--font-heading)', fontSize: '18vw', fontWeight: 700, margin: 0, lineHeight: 0.8, color: 'var(--bg-charcoal)', textTransform: 'uppercase', letterSpacing: '-0.02em', width: '100%', textAlign: 'center' }}
        >
          AJINKYA
        </motion.h1>
      </div>
